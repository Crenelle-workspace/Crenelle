...
export async function sendInvitationWhatsApp({
  ...
  // Self-hosted QR Code image URL generated by Crenelle API
  ...
  try {
    ...
    console.error('[whatsapp] Request exception during WhatsApp Graph API dispatch:', err)
    return { error: err.message || 'Network error sending WhatsApp message via Meta Cloud API' }
  }
}
