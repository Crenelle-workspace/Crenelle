  ...
  return (
    <div className="bg-background text-foreground min-h-screen flex flex-col font-['Inter',ui-sans-serif,system-ui,sans-serif] selection:bg-copper/30 selection:text-white overflow-x-hidden w-full">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden select-none z-0">
        ...
        <div className="absolute top-[30%] -right-[10%] w-[50vw] max-w-130 h-[50vw] max-h-130 rounded-full bg-amber-500/6 dark:bg-amber-500/4 blur-[130px]" />
      ...
      <main className="flex-1 relative z-10 pt-32 md:pt-40 pb-20 w-full max-w-7xl mx-auto px-6 md:px-12 space-y-16 md:space-y-20">
        {/* ── HERO SECTION ── */}
        <section className="max-w-4xl mx-auto text-center space-y-6 pt-4">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Get clear answers on ticket fees, Paystack bank payouts, refund handling,
            and our browser-based door scanning technology.
          </p>
        </section>
