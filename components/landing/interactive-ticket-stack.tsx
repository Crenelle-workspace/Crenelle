  ...
  const tickets = [
    {
      ...
      bgClass: 'bg-stone-50 dark:bg-[#161514] border-stone-200 dark:border-stone-800 text-stone-900 dark:text-stone-100',
      tagClass: 'text-stone-600 dark:text-stone-400 font-bold',
      qrColorClass: 'text-stone-900 dark:text-stone-100',
      qrBorderClass: 'border-stone-300 dark:border-stone-700 bg-stone-100 dark:bg-stone-900/50',
      rotActive: -8,
      xActive: -100,
      yActive: 10,
      rotIdle: -4,
    ...
    },
    {
      ...
      bgClass: 'bg-stone-950 text-stone-100 border-[#BF8430]/40 dark:border-[#BF8430]/60 shadow-[0_15px_30px_rgba(191,132,48,0.15)]',
    ...
    },
    {
      ...
      bgClass: 'bg-amber-50/50 dark:bg-[#181613] border-amber-900/10 dark:border-amber-950/30 text-amber-950 dark:text-amber-100',
      tagClass: 'text-amber-700 dark:text-amber-400 font-bold',
      qrColorClass: 'text-amber-950 dark:text-amber-100',
      qrBorderClass: 'border-amber-200/50 dark:border-amber-900/40 bg-amber-100/30 dark:bg-amber-950/20',
      rotActive: 8,
      xActive: 100,
      yActive: 10,
      rotIdle: 4,
      ...
      {tickets.map((t) => (
        ...
        >
          ...
          <div className="space-y-1.5 text-left pt-2">
            <span className={cn("font-mono text-[8px] tracking-wider block", t.tagClass)}>
              {t.tag}
            </span>
