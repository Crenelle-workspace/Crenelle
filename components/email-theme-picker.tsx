...
const THEME_OPTIONS: ThemeOption[] = [
  ...
  },
  {
    id: 'luxe_dark',
    name: 'Luxe Dark Gala',
    subtitle: 'VIP Night & Gala',
    description: 'Deep dark slate card framed with champagne gold metallic accents and elegant serif headings for luxury events.',
    icon: Moon,
    badge: 'LUXURY',
    accentColor: '#D4AF37',
  },
  {
    ...
    subtitle: 'Concert & Summit',
    description: 'Electric neo-brutalist poster layout with vibrant header banner, high-visibility badges, and punchy block cards.',
    icon: Flame,
    badge: 'HIGH-ENERGY',
    accentColor: '#4F46E5',
  },
