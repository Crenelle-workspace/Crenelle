...
describe('calculatePaymentBreakdown', () => {
  it('computes ticket fee, Crenelle processing fee, total amount, and organiser payout', () => {
    ...
    expect(breakdown.totalAmountKobo).toBe(1050000) // ₦10,500 (10,000 + 500)
    expect(breakdown.organiserPayoutKobo).toBe(1000000) // ₦10,000 (100% of ticket fee)
  ...
  it('handles custom platform fee percentage', () => {
    ...
    expect(breakdown.totalAmountKobo).toBe(2200000) // ₦22,000 (20,000 + 2,000)
    expect(breakdown.organiserPayoutKobo).toBe(2000000) // ₦20,000 (100% of ticket fee)
